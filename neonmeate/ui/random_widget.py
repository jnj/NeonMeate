...
class RandomWidget(Gtk.Box):
    ...
    def __init__(self):
        ...
        input_controller = Gtk.EventControllerFocus()
        input_controller.connect('leave', self._on_unfocus_entry)
        self._number_entry.add_controller(input_controller)
        ...
        self._add_btn = Gtk.Button.new_with_label('Add Random')
        self.append(self._add_btn)
        self.append(self._number_entry)
